...
default, the encode functions do not include the padding characters. If you want the
padding characters, pass a `true` value to the second (`includePadding`) argument.
